...
const Blog = () => {
  return (
    <section className='flex justify-center items-center w-[100%] h-auto m-auto bg-slate-900'>
      <div className='bg-slate-900 pt-5 pr-0 pb-5 pl-0'>
        <div
          className='w-full bg-slate-900 pt-4 pr-5 pb-6 pl-5 mt-0 mr-auto mb-0 ml-auto space-y-5 sm:py-8 md:py-12 sm:space-y-8 md:space-y-16
      max-w-7xl'
        >
          <div className='flex flex-col bg-slate-800 rounded-md p-5 text-white items-center sm:px-5 md:flex-row'>
            ...
            <div className='w-full md:w-1/2'>
              <div className='block'>
                <img
                  src='https://blog.openreplay.com/images/integrating-axios-with-react-hooks/images/hero.png'
